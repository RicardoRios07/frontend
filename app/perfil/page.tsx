    ...
    <main className="min-h-screen bg-white">
      ...
      <Footer />
            ...
            <Card className="p-6 bg-blue-50 border-blue-200">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Tu cuenta está protegida con autenticación JWT. Tus datos personales se almacenan de forma segura en
                nuestros servidores.
              </p>
              <div className="bg-white rounded-lg p-4 space-y-2">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <p className="text-sm text-gray-700">Autenticación con JWT habilitada</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <p className="text-sm text-gray-700">Conexión segura HTTPS</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <p className="text-sm text-gray-700">Datos encriptados en tránsito</p>
